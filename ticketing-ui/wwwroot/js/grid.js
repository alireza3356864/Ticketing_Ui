$(document).ready(function () {
  ...
  //  var toggle1=document.getElementById("sidebar-dropdown-toggle-1");
  //  var toggle2=document.getElementById("sidebar-dropdown-toggle-2");
  //  var toggle3=document.getElementById("sidebar-dropdown-toggle-3");

  //  var sidebarlink=document.getElementById("sidebar-dropdown");
  //  var sidebarlink2=document.getElementById("sidebar-dropdown-2");
  //  var sidebarlink3=document.getElementById("sidebar-dropdown-3");

  //  var check=true;
  //  toggle1.addEventListener("click",function(){
  //   sidebarlink3.classList.remove("sidebar-dropdown-active");
  //   sidebarlink2.classList.remove("sidebar-dropdown-active");
  //   sidebarlink.classList.remove("sidebar-dropdown-active");
  //    console.log("click1");
  //    if(check===true){

  //     sidebarlink.classList.add("sidebar-dropdown-active");
  //     check=false;
  //    }else{
  //     check=true;
  //    }
  ...
  //   sidebarlink3.classList.remove("sidebar-dropdown-active");
  //   sidebarlink2.classList.add("sidebar-dropdown-active");
  //   sidebarlink.classList.remove("sidebar-dropdown-active");
  //  });
  //  toggle3.addEventListener("click",function(){
  //   sidebarlink3.classList.add("sidebar-dropdown-active");
  //   sidebarlink2.classList.remove("sidebar-dropdown-active");
  //   sidebarlink.classList.remove("sidebar-dropdown-active");
  //  });
